  ...
  <marin>
    ...
    <section className="flex flex-row justify-center w-full min-h-screen">
      ...
      {blogPosts.map((blogpost, index) =>
        <BlogPostCard key={index} blogpostId={blogpost.id_blogpost} title={blogpost.title} description={blogpost.description} authorId={blogpost.id_author} initDate={blogpost.date} tags={[]} likes={blogpost.likes} />
      )}
        </section>
    </section>
    </marin>
